...
class PunicoesList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_Punicoes';
    ...
    public function __construct()
    {
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['PunicoesForm', 'onShow']), 'fa:plus #69aa46');
