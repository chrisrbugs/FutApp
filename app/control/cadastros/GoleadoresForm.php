...
class GoleadoresForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_Goleadores';
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $object = new Goleadores(); // create an empty object 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Goleadores($key); // instantiates the Active Record 
