...
class GoleadoresList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'Goleadores';
    private static $primaryKey = 'id';
    private static $formName = 'formList_Goleadores';
    ...
    public function __construct()
    {
        ...
        $column_num_gols = new TDataGridColumn('num_gols', 'Num gols', 'left');
        ...
        if ( TSession::getValue('logged') )
        {
          ...
          $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['GoleadoresForm', 'onShow']), 'fa:plus #69aa46');
          ...
          $action_onDelete = new TDataGridAction(array('GoleadoresList', 'onDelete'));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new Goleadores($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Goleadores
