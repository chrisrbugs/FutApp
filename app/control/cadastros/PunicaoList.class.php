...
class PunicaoList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        if ( TSession::getValue('logged') )
        {
          ...
          $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['PunicaoForm', 'onShow']), 'fa:plus #69aa46');
          $action_onShow = new TDataGridAction(array('PunicaoForm', 'onEdit'));
          ...
          $action_onDelete = new TDataGridAction(array('PunicaoList', 'onDelete'));
