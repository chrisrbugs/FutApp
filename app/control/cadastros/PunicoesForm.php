...
class PunicoesForm extends TPage
{
    protected $form;
    private $formFields = [];
    private static $database = 'futapp';
    private static $activeRecord = 'Punicoes';
    private static $primaryKey = 'id';
    private static $formName = 'form_Punicoes';
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $object = new Punicoes(); // create an empty object 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Punicoes($key); // instantiates the Active Record 
